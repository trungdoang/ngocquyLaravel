...
<head>
    ...
    <style>
        ...
        .bg-login-image {
            background-image: url(./dist/img/tomhum.jpg);
            ...
            <div class="col-lg-6">
                ...
                <form action="" method="post">
                    <div class=" form-floating mb-3">
                        <input class="form-control" id="inputEmail" type="text" placeholder="name@example.com" name="email" value='<?php if (isset($_POST['email'])) {
                                                                                                                                        echo $_POST['email'];
                                                                                                                                    } ?>' />
                    ...
                    <button name="submit" type="submit" class="btn btn-primary btn-user btn-block " data-bs-toggle="modal" data-bs-target="#myModal">Login</button>
                    </a>
                    <hr>
                    <div class="text-center">
                            ...
                            if ($query = $conn->prepare("SELECT * FROM user WHERE email = ? OR phone_number = ? ")) {
                                ...
                                if ($row) {
                                    ...
                                    if (password_verify($_POST['pwd'], $hash)) {
                                        ...
                                        if ($row['role_id'] >= 2) {
                                            header("location: http://localhost/quanlynhahang/");
                                        } else {
                                            header("location: http://localhost/quanlynhahang/admin/index.php");
                                        }
                                        exit;
                                    } else {
