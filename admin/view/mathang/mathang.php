                ...
                <div class="bottom-body">
                    <table border="1" class="table table-bordered">
                        ...
                        <?php
                            ...
                            $sql = "SELECT *, category.name FROM `product`,`category` WHERE category.id= product.category_id ";
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="100px"><img src="../../../dist/img/<?php echo $row['thumbnail'];  ?>" alt="" width="100px" height="80px"></td>
                                <td>100</td>
