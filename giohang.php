...
<head>
	...
	<link rel="stylesheet" href="dist/assets/dest/vendors/colorbox/example3/colorbox.css">
		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="index.html">Trang Đặt Hàng</a> / <span>Giỏ Hàng</span>
				</div>
			</div>
				...
				<table class="shop_table beta-shopping-cart-table" cellspacing="0">
					<thead>
						<tr>
							...
							<th class="product-status">Trang thái</th>
					...
					<tfoot>
						<tr>
							<td colspan="6" class="actions">
								...
								<button type="submit" class="beta-btn primary" name="update_cart"> Cập Nhập Giỏ Hàng <i class="fa fa-chevron-right"></i></button> 
								<button type="submit" class="beta-btn primary" name="proceed">Thành Toán <i class="fa fa-chevron-right"></i></button>
							</td>
						</tr>
					</tfoot>
				</table>
